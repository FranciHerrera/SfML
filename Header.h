...
void Grafo::startHistory()
{

	Sprite imagen0, imagen1, imagen2, imagen3, imagen_3, imagen4, imagen5, imagen6, imagen7;
	...
	imagen_3.setTexture(texture3); imagen_3.setPosition(0, 0);
